...
const styles = StyleSheet.create({
  ...
  crashTitle: { fontSize: 18, fontWeight: '700', color: '#111827', marginBottom: 8 },
  crashMsg: { fontSize: 14, color: '#DC2626', textAlign: 'center', marginBottom: 12 },
  crashHint: { fontSize: 13, color: '#6B7280', textAlign: 'center' },
});
